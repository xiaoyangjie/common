...
/**
 * description : 这个服务，提供的key都是String，etc.
 *               如果有其他需求，请使用自定义方法继承这个类，自己实现
 *
 * @author yangjie [yang.jie@unisinsight.com]
 * @date 2019/07/27 09:01
 * @since 1.0
 */

@Component
@SuppressWarnings("unchecked")
public class RedisServer <V> {
    ...
    /**
     * 删除key,如果使用pipeline / transaction ， 那么返回true
     *
     * @param key
     */
    public boolean delete(String key) {
        return RedisUtil.removeNull(redisTemplate.delete(key));
    }
    ...
    /**
     * 是否存在key, 如果使用pipeline / transaction ， 那么返回true
     *
     * @param key
     * @return
     */
    public boolean hasKey(String key) {
        return RedisUtil.removeNull(redisTemplate.hasKey(key));
    }
    ...
    public boolean setBit(String key, long offset, boolean value) {
        return RedisUtil.removeNull(redisTemplate.opsForValue().setBit(key, offset, value));
    }
    ...
    public boolean setIfAbsent(String key, V value) {
        return RedisUtil.removeNull(redisTemplate.opsForValue().setIfAbsent(key, value));
    }
    ...
    public boolean multiSetIfAbsent(Map<String, V> maps) {
        return RedisUtil.removeNull(redisTemplate.opsForValue().multiSetIfAbsent(maps));
    }
     ...
     * @return
     */
    public <HK, HV> List<HV> hMultiGet(String key, Collection<HK> fields) {
        HashOperations hashOperations = redisTemplate.opsForHash();
    ...
    public <HK, HV> void hPutAll(String key, Map<HK, HV> maps) {
     ...
     * @return
     */
    public <HK, HV> Boolean hPutIfAbsent(String key, HK hashKey, HV value) {
     ...
     * @return
     */
    public <HK, HV> boolean hExists(String key, HK field) {
     ...
     * @return
     */
    public <HK, HV> Long hIncrBy(String key, HK field, long increment) {
     ...
     * @return
     */
    public <HK, HV> Double hIncrByFloat(String key, Object field, double delta) {
     ...
     * @return
     */
    public <HK, HV> Set<HV> hKeys(HK key) {
        HashOperations hashOperations = redisTemplate.opsForHash();
    ...
    public boolean sMove(String key, V value, String destKey) {
        return RedisUtil.removeNull(redisTemplate.opsForSet().move(key, value, destKey));
    }
    ...
    public boolean sIsMember(String key, Object value) {
        return RedisUtil.removeNull(redisTemplate.opsForSet().isMember(key, value));
    }
    ...
    public boolean zAdd(String key, V value, double score) {
        return RedisUtil.removeNull(redisTemplate.opsForZSet().add(key, value, score));
    }
     ...
     * @return
     */
    public Long zAdd(String key, Set<ZSetOperations.TypedTuple<V>> values) {
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<V>> zRangeWithScores(String key, long start,
                                                                   long end) {
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<V>> zRangeByScoreWithScores(String key,
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<V>> zReverseRangeWithScores(String key,
                                                                          long start, long end) {
     ...
     * @return
     */
    public Cursor<ZSetOperations.TypedTuple<V>> zScan(String key, ScanOptions options) {
